...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        team1.members.add(user1, user2)  # Correctly add members to the team
        ...
        Workout.objects.create(user=user1, description='Morning Yoga', date=date(2025, 4, 13))  # Use date object
        Workout.objects.create(user=user2, description='Evening Run', date=date(2025, 4, 13))
